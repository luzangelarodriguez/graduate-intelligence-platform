...
DOMAIN_DEFINITIONS: tuple[DomainDefinition, ...] = (
    ...
    DomainDefinition(
        "criminology",
        "Criminology",
        "Criminologia, investigacion criminal, criminalistica, seguridad publica, forense y prevencion del delito.",
        (
            "criminology",
            "criminologia",
            "criminalistics",
...
SKILL_DEFINITIONS: tuple[SkillDefinition, ...] = (
    ...
    SkillDefinition("criminal investigation", "criminology", "technical_skill", aliases=("investigacion criminal", "investigacion criminalistica", "criminalistica investigacion", "investigacion judicial")),
    SkillDefinition("victimology", "criminology", "technical_skill", aliases=("victimologia", "victim assistance", "atencion a victimas")),
    SkillDefinition("criminal profiling", "criminology", "technical_skill", aliases=("perfilacion criminal", "perfilamiento criminal", "profiling")),
    SkillDefinition("criminal intelligence", "criminology", "technical_skill", aliases=("inteligencia criminal", "intelligence analysis", "analisis de inteligencia criminal")),
    SkillDefinition("criminal policy", "criminology", "technical_skill", aliases=("politica criminal", "politica criminologica")),
    SkillDefinition("crime prevention", "criminology", "technical_skill", aliases=("prevencion del delito", "prevention of crime")),
    SkillDefinition("public security", "criminology", "technical_skill", aliases=("seguridad ciudadana", "public safety", "seguridad publica")),
    SkillDefinition("cybercrime", "criminology", "technical_skill", aliases=("ciberdelito", "delito informatico", "computer crime")),
    SkillDefinition("criminal analysis", "criminology", "technical_skill", aliases=("analisis criminal", "analisis criminologico", "criminal analysis")),
    SkillDefinition("forensic analysis", "criminology", "technical_skill", aliases=("analisis forense", "criminalistica", "criminalistics", "forensic science", "forensics")),
    SkillDefinition("chain of custody", "criminology", "technical_skill", aliases=("cadena de custodia", "custodia de evidencia")),
    SkillDefinition("risk analysis", "criminology", "technical_skill", aliases=("analisis de riesgo", "risk assessment", "evaluation of risk")),
    SkillDefinition("penitentiary systems", "criminology", "technical_skill", aliases=("sistemas penitenciarios", "penitentiary", "prison systems")),
    SkillDefinition("organized crime", "criminology", "technical_skill", aliases=("crimen organizado", "organized criminal networks")),
    SkillDefinition("financial crime", "criminology", "technical_skill", aliases=("delito financiero", "fraude financiero", "money laundering", "financial fraud")),
