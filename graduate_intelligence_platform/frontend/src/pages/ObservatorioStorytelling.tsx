...
import unirLogoPng from '../assets/logos/UNIR_fundacion_blanco.png';
    ...
    <div className="flex min-h-screen lg:h-screen lg:overflow-hidden" style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}>
      ...
      >
        ...
        <div style={{ padding: '20px 16px 14px', flexShrink: 0 }}>
          <img src={unirLogoPng} alt="UNIR – Fundación Universitaria Internacional de La Rioja" style={{ maxWidth: 160, width: '100%', height: 'auto', display: 'block', marginBottom: 4 }} />
