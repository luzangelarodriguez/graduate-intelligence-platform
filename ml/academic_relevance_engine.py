...
SKILLS_LOOKUP: List[str] = [
    ...
    "metodologias agiles",
    # --- Project management (PMBOK / certifications / roles) ---
    "pmp", "pmbok", "pmi", "prince2", "capm", "pmo",
    "scrum master", "product owner", "project manager",
    "director de proyecto", "director de proyectos",
    "gerente de proyecto", "gerente de proyectos",
    "coordinador de proyectos", "coordinador de proyecto",
    "lider de proyecto", "lider de proyectos",
    # --- Project management (planning / scope / schedule) ---
    "cronograma", "cronogramas", "cronograma de proyecto",
    "planeacion de proyectos", "planificacion de proyectos",
    "acta de constitucion", "project charter",
    "alcance del proyecto", "gestion del alcance",
    "estructura de desglose de trabajo", "wbs", "edt",
    "gestion del cronograma", "diagrama de gantt", "gantt",
    "ruta critica", "critical path", "hitos", "milestones",
    "linea base", "triple restriccion",
    # --- Project management (cost / risk / quality / stakeholders) ---
    "gestion de costos", "gestion del costo", "presupuesto de proyecto",
    "valor ganado", "earned value", "curva s",
    "gestion de riesgos", "gestion del riesgo", "matriz de riesgos",
    "gestion de la calidad", "gestion de interesados",
    "gestion de stakeholders", "stakeholders", "interesados del proyecto",
    "gestion de adquisiciones", "gestion de la integracion",
    "gestion del cambio", "change management",
    # --- Project management (agile ceremonies / tools) ---
    "sprint", "backlog", "product backlog", "sprint planning",
    "daily standup", "daily scrum", "retrospectiva", "sprint review",
    "ceremonias agiles", "ms project", "microsoft project",
    "primavera p6", "smartsheet", "asana", "monday.com",
    "kickoff", "cierre de proyecto", "acta de cierre",
    # --- Lean / continuous improvement (paired with project management curricula) ---
    "lean", "lean six sigma", "six sigma", "kaizen",
    "mejora continua", "gestion del cambio organizacional",
    # --- Security ---
